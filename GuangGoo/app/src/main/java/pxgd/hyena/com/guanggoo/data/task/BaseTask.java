...
public abstract class BaseTask<T> implements Runnable {
    ...
    protected Map<String, String> getCookies() {
        ...
        String cookieString = PrefsUtil.getString(MyApplication.getInstance(), ConstantUtil.KEY_COOKIE, "");
    ...
    protected String getXsrf() {
        return PrefsUtil.getString(MyApplication.getInstance(), ConstantUtil.KEY_XSRF, "");
    }
