package pxgd.hyena.com.weatherparse;
...
public class MyParse implements MyParseHandler.WeatherEventCallback {
    XmlPullParser xpp;
    ...
    public void parse(Reader xml) throws XmlPullParserException, IOException {
        MyParseHandler eventHandler = new MyParseHandler(this);
        xpp.setInput(xml);
